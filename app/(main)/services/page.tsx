  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] pb-20">
      <div className="sticky top-0 bg-white border-b z-40 px-4 py-4">
        <h1 className="mx-auto max-w-5xl text-2xl font-bold text-[#001533]">Services</h1>
      </div>
      ...
      <div className="mx-auto max-w-4xl p-4 lg:px-8 lg:py-8">
        <div className="rounded-3xl bg-white p-8 text-center lg:p-12">
          ...
          <button
            ...
            className={`mx-auto mt-10 flex w-full max-w-xl items-center justify-center gap-3 rounded-2xl py-4 font-semibold transition-all ${
              hasVoted 
